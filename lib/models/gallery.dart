...
class GalleryModel {
  static CollectionReference collectionReference = FirebaseFirestore.instance.collection('gallery');

  static Future<void> create(String uid, String uname, File? imageFile, String name, String description) async {
    String filename = basename(imageFile!.path);

    Reference ref = FirebaseStorage.instance.ref('gallery/').child(filename);
